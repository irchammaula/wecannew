                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Saldo Portal Pulsa</div>
                                                @if(isset($message))
                                                    {{-- <p><strong>Pesan:</strong> {{ $message }}</p> --}}
                                                @endif
                                                @if(isset($balance))
                                                    <p><strong>Saldo Terakhir:</strong> Rp {{ number_format($balance, 0, ',', '.') }}</p>
                                                @else
                                                    <p>Data saldo tidak tersedia.</p>
                                                @endif
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Request Deposit</div>
                                                <form action="{{ route('admin.dashboard.depopulsa') }}" method="POST">
                                                    @csrf
                                                    <div class="mb-3">
                                                    ...
                                                    <button class="btn btn-primary" type="submit">Request Deposit</button>
                                                </form>
                                        
                                                <!-- Message from API (SweetAlert triggered here) -->
                                                @if(isset($message))
                                                    <script>
                                                        Swal.fire({
                                                            icon: 'info',
                                                            title: 'Pesan dari Portal Pulsa',
                                                            text: '{{ $message }}',
