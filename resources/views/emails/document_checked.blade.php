                      ...
                      <tbody>
                        <tr>
                          <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                            ...
                            <img class="w-16" src="" style="height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; width: 64px; border-style: none; border-width: 0;" width="64">
                            <table class="s-6 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 24px; width: 100%; height: 24px; margin: 0;" align="left" width="100%" height="24">
                            ...
                            <div class="space-y-4">
                              <h1 class="text-4xl fw-800" style="padding-top: 0; padding-bottom: 0; font-weight: 800 !important; vertical-align: baseline; font-size: 36px; line-height: 43.2px; margin: 0;" align="left">Halo, {{ $customerName }}</h1>
                              ...
                              <p class="" style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">Terimakasih udah pake layanan kami, semoga tugas kamu segera selesai ya sob..., file kamu udah kami periksa, kamu bisa download lampiran dibawah email ini ya sobat.., have a nice day</p>
                              <table class="s-4 w-full" role="presentation" border="0" cellpadding="0" cellspacing="0" style="width: 100%;" width="100%">
                                <tbody>
                                  <tr>
                                    <td style="line-height: 16px; font-size: 16px; width: 100%; height: 16px; margin: 0;" align="left" width="100%" height="16">
                              ...
                              <tbody>
                                <tr>
                                  <td style="line-height: 24px; font-size: 16px; width: 100%; border-radius: 24px; margin: 0; padding: 40px;" align="left" bgcolor="#ffffff">
                                    <h3 class="text-center" style="padding-top: 0; padding-bottom: 0; font-weight: 500; vertical-align: baseline; font-size: 28px; line-height: 33.6px; margin: 0;" align="center">Cek Turnitin</h3>
                                    ...
                                    <p style="line-height: 24px; font-size: 16px; width: 100%; margin: 0;" align="left">Jika kamu punya pertanyaan atau saran, kamu bisa hubungi di: <a href="https://api.whatsapp.com/send?phone=62895326616661" style="color: #0d6efd;"><span class="__cf_email__" data-cfemail="8dc5e4fdcee2fffdcde8f5ece0fde1e8a3eee2e0">Whatsapp</span></a>.</p>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
